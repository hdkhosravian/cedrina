...
from core.metrics import MetricsCollector, metrics_collector, record_metric
...
def test_collect_system_metrics(collector, mocker):
    ...
    mocker.patch('psutil.virtual_memory', return_value=Mock(percent=30.0, used=3000000000, total=10000000000))
    mocker.patch('psutil.disk_usage', return_value=Mock(percent=40.0, used=40000000000, total=100000000000))
...
def test_get_metrics_updates_system_metrics(collector, mocker):
    ...
    mocker.patch('psutil.virtual_memory', return_value=Mock(percent=25.0, used=2500000000, total=10000000000))
    mocker.patch('psutil.disk_usage', return_value=Mock(percent=35.0, used=35000000000, total=100000000000))

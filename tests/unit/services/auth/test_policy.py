...
class TestPolicyService:
    ...
    def test_add_policy_success(self, policy_service, mock_enforcer):
        ...
        result = policy_service.add_policy("admin", "/test", "GET", "user_123", "192.168.1.1", "Mozilla/5.0", None, "en")
    ...
    def test_add_policy_with_attributes_success(self, policy_service, mock_enforcer):
        ...
        result = policy_service.add_policy("admin", "/test", "GET", "user_123", "192.168.1.1", "Mozilla/5.0", attributes, "en")
        assert result is True
        mock_enforcer.add_policy.assert_called_once_with("admin", "/test", "GET", "engineering", "NY", "day")
    ...
    def test_add_policy_invalid_input(self, policy_service):
        ...
        with pytest.raises(PermissionError) as exc_info:
            policy_service.add_policy("", "/test", "GET", "user_123", "192.168.1.1", "Mozilla/5.0", None, "en")
    ...
    def test_remove_policy_success(self, policy_service, mock_enforcer):
        ...
        result = policy_service.remove_policy("admin", "/test", "GET", "user_123", "192.168.1.1", "Mozilla/5.0", "en")
        assert result is True
    ...
    def test_remove_policy_invalid_input(self, policy_service):
        ...
        """
        with pytest.raises(PermissionError) as exc_info:
            policy_service.remove_policy("", "/test", "GET", "user_123", "192.168.1.1", "Mozilla/5.0", "en")
    ...
    def test_get_policies_success(self, policy_service, mock_enforcer):
        ...
        Args:
            ...
            mock_enforcer: The mock Casbin Enforcer instance.
        """
        mock_enforcer.get_policy.return_value = [["admin", "/health", "GET"], ["admin", "/metrics", "GET"]]

...
from src.utils.i18n import _translations, get_request_language, get_translated_message, setup_i18n
...
def test_get_translated_message_not_found(mocker):
    ...
    mock_logger.warning.assert_called_with(
        "translation_key_not_found", key="untranslated_key", locale="en"
    )

...
from src.domain.rate_limiting.services import AdvancedRateLimiter, RateLimitService, RateLimitContext
from src.domain.rate_limiting.entities import RateLimitRequest
from src.domain.rate_limiting.value_objects import RateLimitQuota, RateLimitAlgorithm, RateLimitKey
...
class TestRateLimitingPerformance:
    ...
    async def test_single_request_latency(self):
        ...
        # Mock repository to return instant response
